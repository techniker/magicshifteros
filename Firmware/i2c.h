// Taken from Sparkfun Example: https://www.sparkfun.com/products/10953
//
// 4.10.2012: Adapted for Arduino Leonardo by wizard23 / wizards23+bitbucket@gmail.com
//            by adapting WRITE_sda and READ_sda to the correct pins for ATMEGA32U4
...
#define cbi(var, mask)   ((var) &= (uint8_t)~(1 << mask))
  ...
  // Settigs for Arduino Leonardo:
  // SDA is on PD1 so it must be DDRD with mask 0b00000010
